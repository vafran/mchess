...
> - **The Immortal**: the hardest no-undo challenge — beating the Master without a single mistake.
> - **David vs Goliath**: watch the eval bar go deep red and then fight back to a win.
...
## 📜 Historians — Medal: 📜
*Recreate legendary sacrifices from chess history.*

These trophies are unlocked by playing specific famous moves in any position. Load from the **FEN Training Library → (Legends)** tab for the easiest setup.
...
| ⭐ | **Estudiante Ejemplar / Lesson Master** | Complete **all lessons** in Tutorial mode. |
...
| 🌪️ | **Chaos Theory** | Have **4 consecutive half-moves** all be captures — a full fireworks sequence. |
...
> - **Chaos Theory**: look for forcing exchange sequences in the center — both sides trading pieces rapidly.
