...
**📚 Learning (8):** Use the Coach 10 times, explore 5 named openings, complete your first puzzle 🎓, complete 10 puzzles total 🔁, use "What should I do?" 3 times in one game (*Hint Seeker* 📖), review your play with "Was it good?" 5 times (*The Analyst*), complete 3 openings + 4 mate-1s + 6 mate-2s + 8 mate-3s + 10 mate-4s (*FEN Master* 🧘), and complete all tutorial lessons (*Lesson Master* 🎓).
